 ...
 *
 * If the user has the required role(s) AND an access token, it renders the child routes.
 * Otherwise, it redirects them to an unauthorized page or the login page.
 *
 * @param {object} props - The component props.
 * @param {Array<number>} props.allowedRoles - An array of numeric role codes that are allowed to access this route.
 */
